...
const StackNavigation = () => {
  ...
  return (
    ...
    >
      ...
      <MainStack.Screen
        name="AttachmentPharmacy"
        component={AttachmentPharmacy}
      />
      <MainStack.Screen
        name="MedicationPharmacy"
        component={MedicationPharmacy}
      />
      ...
      <MainStack.Screen
        ...
        component={AvailabilityPharmacy}
      />
      ...
      <MainStack.Screen
        name="AssurancePaymentDone"
        component={AssurancePaymentDone}
      />
      ...
      <MainStack.Screen
        name="WorkingDetailAgenda"
        component={WorkingDetailAgenda}
      />
      <MainStack.Screen
        name="StuffDetailHospital"
        component={StuffDetailHospital}
      />
      <MainStack.Screen
        name="StuffDetailPharmacy"
        component={StuffDetailPharmacy}
      />
      <MainStack.Screen
        name="AssociationDetailHospital"
        component={AssociationDetailHospital}
      />
      <MainStack.Screen
        name="AssociationDetailPharmacy"
        component={AssociationDetailPharmacy}
      />
      <MainStack.Screen
        name="AddServicesPharmacy"
        component={AddServicesPharmacy}
      />
      <MainStack.Screen
        name="AddServicesHospital"
        component={AddServicesHospital}
      />
      <MainStack.Screen
        name="WorkingDetailPharmacy"
        component={WorkingDetailPharmacy}
      />
      <MainStack.Screen
        name="WorkingDetailHospital"
        component={WorkingDetailHospital}
      />
      <MainStack.Screen
        name="AddANewDoctorPharmacy"
        component={AddANewDoctorPharmacy}
      />
      <MainStack.Screen
        name="AddANewDoctorHospital"
        component={AddANewDoctorHospital}
      />
      <MainStack.Screen
        name="HospitalityAppHome"
        component={HospitalityAppHome}
      />
      <MainStack.Screen name="PharmacyAppHome" component={PharmacyAppHome} />
      <MainStack.Screen
        name="AgendaDrugRequest"
        component={AgendaDrugRequest}
      />
      <MainStack.Screen
        name="DoctorDetailHospital"
        component={DoctorDetailHospital}
      />
      <MainStack.Screen
        name="DoctorDetailPharmacy"
        component={DoctorDetailPharmacy}
      />
      <MainStack.Screen name="AgendaSendBill" component={AgendaSendBill} />
      <MainStack.Screen
        name="AvailableDrugsPharmacy"
        component={AvailableDrugsPharmacy}
      />
      <MainStack.Screen
        name="AvailableDrugsDetail"
        component={AvailableDrugsDetail}
      />
      <MainStack.Screen
        name="AddDrugsDetailPharmacy"
        component={AddDrugsDetailPharmacy}
      />
      <MainStack.Screen
        name="RequestANewMedicineDetail"
        component={RequestANewMedicineDetail}
      />
      <MainStack.Screen
        name="CurrentCampaignPharmacy"
        component={CurrentCampaignPharmacy}
      />
      <MainStack.Screen
        name="SetCampaignPharmacy"
        component={SetCampaignPharmacy}
      />
      <MainStack.Screen
        name="OverViewHospitality"
        component={OverViewHospitality}
      />
      <MainStack.Screen
        name="AgendaAppointmentHospital"
        component={AgendaAppointmentHospital}
      />
      <MainStack.Screen
        name="AgendaAppointmentDetailPharmacy"
        component={AgendaAppointmentDetailPharmacy}
      />
      <MainStack.Screen
        name="TestAppointmentDetailPharmacy"
        component={TestAppointmentDetailPharmacy}
      />
      <MainStack.Screen
        name="SpecialistAndDiagnosticsHospital"
        component={SpecialistAndDiagnosticsHospital}
      />
      <MainStack.Screen name="DentistsHospital" component={DentistsHospital} />
      <MainStack.Screen
        name="AddSpecializationHospital"
        component={AddSpecializationHospital}
      />
      <MainStack.Screen
        name="UltraSoundHospital"
        component={UltraSoundHospital}
      />
      <MainStack.Screen
        name="ProfileDetailHopital"
        component={ProfileDetailHopital}
      />
      <MainStack.Screen
        name="CreatePostHospital"
        component={CreatePostHospital}
      />
      <MainStack.Screen
        name="PersonalDetailDoctor"
        component={PersonalDetailDoctor}
      />
      <MainStack.Screen
        name="AssociationDetailDonation"
        component={AssociationDetailDonation}
      />
      <MainStack.Screen
        name="AssociationDetailDoctor"
        component={AssociationDetailDoctor}
      />
      <MainStack.Screen
        name="RegisteredClientsAssurance"
        component={RegisteredClientsAssurance}
      />
      <MainStack.Screen
        name="AssuranceAgendaReports"
        component={AssuranceAgendaReports}
      />
      <MainStack.Screen
        name="AssuranceCompanyDetail"
        component={AssuranceCompanyDetail}
      />
      <MainStack.Screen
        name="AssuranceAddANewPlan"
        component={AssuranceAddANewPlan}
      />
      <MainStack.Screen
        name="AssurancesAndInsuranceAppHome"
        component={AssurancesAndInsuranceAppHome}
      />
      <MainStack.Screen
        name="AssuranceReportDetail"
        component={AssuranceReportDetail}
      />
      <MainStack.Screen
        name="IssuranceEditDetail"
        component={IssuranceEditDetail}
      />
      <MainStack.Screen
        name="AssuranceTracking"
        component={AssuranceTracking}
      />
      <MainStack.Screen
        name="AssuranceAddplanDetail"
        component={AssuranceAddplanDetail}
      />
      <MainStack.Screen
        name="AssuranceEditPlanDetail"
        component={AssuranceEditPlanDetail}
      />
      <MainStack.Screen
        name="TrackingIssuranceEditDetail"
        component={TrackingIssuranceEditDetail}
      />
      <MainStack.Screen
        name="AssuranceYourPlans"
        component={AssuranceYourPlans}
      />
      <MainStack.Screen
        name="AssuranceTermsAndCondition"
        component={AssuranceTermsAndCondition}
      />

      <MainStack.Screen
        name="AssurancesAndInsuranceTabBottomNavigation"
        component={AssurancesAndInsuranceTabBottomNavigation}
      />
      <MainStack.Screen
        name="PharmacyTabBottomNavigation"
