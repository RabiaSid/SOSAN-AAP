      ...
      <View style={styles.Center}>
        <View style={styles.GalleryImageColumn}>
          <View style={{ elevation: 6 }}>
            <Image
              source={PharmacieCard4}
              resizeMode={"contain"}
              style={{ height: 120, width: 150, borderRadius: 2 }}
            />
          </View>
          <View style={{ elevation: 6, top: -40 }}>
            <Image
              source={PharmacieCard7}
              resizeMode={"contain"}
              style={{ height: 110, width: 155, borderRadius: 2 }}
            />
          </View>
          <View style={{ elevation: 4, top: -70 }}>
            <Image
              source={PharmacieCard3}
              resizeMode={"cover"}
              style={{ height: 170, width: 160, borderRadius: 5 }}
            />
          </View>
        </View>
